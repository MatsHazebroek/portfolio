...
function Projects() {
	return (
		<>
			<div id="projecten" className="container mx-auto py-8 min-h-screen mt-20">
				<h1 className="text-5xl font-bold mb-8 text-center">Projecten</h1>
				...
				<div className="flex flex-row justify-center flex-wrap gap-4 px-4">
					<div className="w-96 bg-white rounded-lg shadow-lg p-4">
						...
						<p className="text-gray-700 text-base">
							Met een mede fivem developer ben ik scripts gaan ontwerpen. Hier
					...
					<div className="bg-white w-96 rounded-lg shadow-lg p-4">
						...
						<p className="text-gray-700 text-base">
							Het is mogelijk om je favoriete elpees op te slaan. Je kan ze
							toevoegen, aanpassen, verwijderen en bekijken (CRUD)
						</p>
						<div className="mt-3">
					...
					<div className="bg-white w-96 rounded-lg shadow-lg p-4">
						...
						<p className="text-gray-700 text-base">
							Het is mogelijk door taken die je hebt hier te maken. Je kan ze
							toevoegen, aanpassen, verwijderen en bekijken (CRUD)
						</p>
						<div className="mt-3">
							<p className="text-sm text-gray-500 font-bold">
								Next.js (
								<a className="text-blue-500" href="https://create.t3.gg/">
									https://create.t3.gg/
								</a>
								)
							</p>
				...
				<div className="container mx-auto py-8 mt-20">
					...
					<div className="flex flex-row justify-center flex-wrap gap-4 px-4">
						<div className="w-96 bg-white rounded-lg shadow-lg p-4">
							...
							<p className="text-gray-700 text-base">
								Een AI-aangedreven recepten-app die gezonde en heerlijke
								maaltijden voorstelt op basis van de dieetvoorkeuren,
								kookvaardigheden en beschikbare ingrediënten van de gebruiker.
							</p>
							<div className="mt-4 flex justify-between">
								<a
									href="#!"
